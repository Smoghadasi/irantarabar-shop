<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">محصولات</span>
        </li>
        <li class="menu-item ">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-detail"></i>
                <div data-i18n="Form Elements">محصولات</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ route('admin.brand.index') }}" class="menu-link">
                        <div data-i18n="Basic Inputs">برند</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ route('admin.attribute.index') }}" class="menu-link">
                        <div data-i18n="Basic Inputs">ویژگی</div>
                    </a>
                </li>
                <li class="menu-item">
        ...
        <li class="menu-item ">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-detail"></i>
                <div data-i18n="Form Elements">سفارشات</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ route('admin.order.index') }}" class="menu-link">
                        <div data-i18n="Basic Inputs">سفارش ها</div>
                    </a>
                </li>
                <li class="menu-item ">
                    <a href="{{ route('admin.transaction.index') }}" class="menu-link">
                        <div data-i18n="Input groups">تراکنش</div>
                    </a>
                </li>
                <li class="menu-item ">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ route('admin.user.index') }}" class="menu-link">
                        <div data-i18n="Basic Inputs">لیست</div>
                    </a>
                </li>
                <li class="menu-item ">
                    <a href="{{ route('admin.user.create') }}" class="menu-link">
                        <div data-i18n="Input groups">جدید</div>
                    </a>
                </li>
            </ul>
        </li>
        <li class="menu-item">
            <a href="{{ route('admin.roles.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Dashboards">نقش ها</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="{{ route('admin.permissions.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Dashboards">دسترسی ها</div>
            </a>
        </li>

        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">تنظیمات</span>
        </li>
        <li class="menu-item ">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-detail"></i>
                <div data-i18n="Form Elements">تنظیمات</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ route('admin.banners.index') }}" class="menu-link">
                        <div data-i18n="Basic Inputs">بنر ها</div>
                    </a>
                </li>
            </ul>
        </li>
