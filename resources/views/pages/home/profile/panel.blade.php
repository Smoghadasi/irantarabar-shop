                   ...
                   <div class="tab-product-nav tab-panel-tbl  p-3 rounded-3">
                       <ul class="nav nav-tabs" id="myTab" role="tablist">
                           <li class="nav-item" role="presentation">
                               <button class="nav-link active btn border-bottom-0" id="latest-order" data-bs-toggle="tab" data-bs-target="#latest-order-pane" type="button" role="tab" aria-controls="latest-order-pane" aria-selected="true">آخرین سفارشات <span class="badge main-color-green ms-1">1</span> </button>
                           </li>
                           <li class="nav-item" role="presentation">
                               <button class="nav-link btn border-bottom-0" id="favorite-product" data-bs-toggle="tab" data-bs-target="#favorite-product-pane" type="button" role="tab" aria-controls="favorite-product-pane" aria-selected="true">علاقه مندی ها</button>
                           </li>
                           <li class="nav-item" role="presentation">
                               <button class="nav-link btn border-bottom-0" id="cancel-order" data-bs-toggle="tab"
                                       data-bs-target="#cancel-order-pane" type="button" role="tab"
                                       aria-controls="cancel-order-pane" aria-selected="true">لغو شده ها
                               </button>
                           </li>
                       </ul>
                   </div>
                   <div class="tab-content tab-product-content" id="myTabContent">
                                           ...
                                           <td colspan="2" class="align-middle">
                                               ...
                                               <div class="avatar-group d-flex align-items-center justify-content-center assigned-avatar">
                                                   ...
                                                   <div class="avatar avatar-md" data-bs-toggle="tooltip"
                                                        ...
                                                        aria-label="تی شرت لانگ ورزشی مردانه نوزده نودیک مدل TS1967 WW"
                                                        data-bs-original-title="تی شرت لانگ ورزشی مردانه نوزده نودیک مدل TS1967 WW">
                                                       <a href="">
                                                           <img src="assets/img/product/product-image1.jpg"
                                                   ...
                                                   <div class="avatar avatar-md" data-bs-toggle="tooltip"
                                                        ...
                                                        data-bs-original-title="تی شرت لانگ ورزشی مردانه نوزده نودیک مدل TS1967 WW">
                                                       <a href="">
                                                           <img src="assets/img/product/product-image2.jpg"
                                                                alt="Avatar" class="rounded-circle  pull-up">
                                                       </a>
                                                   </div>
                                                   ...
                                                   <div class="avatar avatar-md" data-bs-toggle="tooltip"
                                                        ...
                                                        data-bs-original-title="تی شرت لانگ ورزشی مردانه نوزده نودیک مدل TS1967 WW">
                                                       <a href="">
                                                           <img src="assets/img/product/product-image3.jpg"
                                                                alt="Avatar" class="rounded-circle  pull-up">
                                                       </a>
                                                   </div>
                       ...
                       <div class="tab-pane fade" id="favorite-product-pane" role="tabpanel" aria-labelledby="latest-order" tabindex="0">
                           ...
                           <ul class="row gy-3 ps-0 mt-4">
                                   ...
                                   <div class="cart-canvas border rounded-3 p-3">
                                       <div class="row align-items-center">
                                           <div class="col-4 ps-0">
                                               <img src="assets/img/product/wach1.jpg" width="200" alt="">
                                           </div>
                                           <div class="col-8">
                               ...
                               <div class="col-sm-6">
                                   <div class="cart-canvas p-3 border rounded-3">
                                       <div class="row align-items-center">
                                           <div class="col-4 ps-0">
                                               <img src="assets/img/product/wach4.jpg" width="200" alt="">
                                           </div>
                                           <div class="col-8">
                                               <h3 class="text-overflow-2 font-16">ساعت مچی عقربه‌ای مردانه اینویکتا مدل
                                                   Automatico Ghost Reserve
                               ...
                               <div class="col-sm-6">
                                   <div class="cart-canvas p-3 border rounded-3">
                                       <div class="row align-items-center">
                                           <div class="col-4 ps-0">
                                               <img src="assets/img/product/wach2.jpg" width="200" alt="">
                                           </div>
                                           <div class="col-8">
                                               <h3 class="text-overflow-2 font-16">ساعت مچی عقربه‌ای مردانه اینویکتا مدل
                                                   Automatico Ghost Reserve
                               ...
                               <div class="col-sm-6">
                                   <div class="cart-canvas p-3 border rounded-3">
                                       <div class="row align-items-center">
                                           <div class="col-4 ps-0">
                                               <img src="assets/img/product/wach3.jpg" width="200" alt="">
                                           </div>
                                           <div class="col-8">
                                               <h3 class="text-overflow-2 font-16">ساعت مچی عقربه‌ای مردانه اینویکتا مدل
                                                   Automatico Ghost Reserve
                       ...
                       <div class="tab-pane fade" id="cancel-order-pane" role="tabpanel" aria-labelledby="cancel-order"
                            tabindex="0">
