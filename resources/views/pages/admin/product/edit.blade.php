                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select class="form-control" id="is_active" name="is_active">
                            <option value="1" {{ $product->is_active == 'فعال' ? 'selected' : '' }}>فعال
                            </option>
                            <option value="0" {{ $product->is_active == 'غیر فعال' ? 'selected' : '' }}>غیرفعال
                            </option>
                        </select>
                    </div>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        variations.forEach(variation => {
            $(`#variationInputDateOnSaleFrom-${variation.id}`).persianDatepicker();

            $(`#variationInputDateOnSaleTo-${variation.id}`).persianDatepicker();
        });
    </script>
@endsection
